...
export default function OutletDropdownFilter() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <span className="truncate max-w-[90px] sm:max-w-none">{currentOption.label}</span>
      ...
      {isOpen && (
        <ul
          className="absolute left-0 sm:right-0 sm:left-auto mt-2 w-52 bg-white border border-gray-100 rounded-2xl shadow-xl z-40 p-1.5 focus:outline-none animate-in fade-in slide-in-from-top-2 duration-150"
          role="listbox"
        >
          {options.map((opt) => {
